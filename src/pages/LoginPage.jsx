  ...
  return (
    <div className="min-h-screen flex items-center justify-center  p-4">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-center text-gray-800 dark:text-indigo-300 flex items-center justify-center">
          Iniciar Sesión
        </h2>

        {errorMsg && (
          <p className="text-red-700 dark:text-red-400 bg-red-200 dark:bg-red-900/50 border border-red-400 dark:border-red-700 p-2 rounded text-sm text-center">
            {errorMsg}
          </p>
        )}
        ...
        <div className="relative">
          ...
          <input
            type="email"
            className="w-full pl-10 p-3 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500"
